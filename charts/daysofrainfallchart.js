document.addEventListener("DOMContentLoaded", function () {
    ...
    d3.json("https://api.npoint.io/cdbb11536e0322ac5f2c").then(function (data) {
        ...
        var valueline = d3.line()
            .curve(d3.curveBasis)
            .x(d => x(d.month))
            .y(d => y(d.DaysOfRainfall));

        // Adds the svg canvas
        var g = d3.select("#daysofrainfallchart")
            .append("svg")
            .attr("width", svgWidth)
        ...
        function drawGraph(error, data) {
            ...
            y.domain([0, d3.max(data, d => d3.max(d.weather, g => g.DaysOfRainfall)) + 1]);
            ...
            g.append("g")
                ...
                .attr("dy", "0.5em")
                .attr("fill", "#000")
                .text("Days of Rainfall per month");
